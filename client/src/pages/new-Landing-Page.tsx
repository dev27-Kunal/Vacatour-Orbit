    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-screen overflow-y-auto">
        ...
        <div className="flex flex-col">
          <section className="flex flex-col items-center min-h-[100vh] gap-6 sm:gap-8 md:gap-10 justify-center px-4 sm:px-6 lg:px-8">
          ...
          <section className="flex flex-col items-center gap-8 sm:gap-12 md:gap-16 mb-16 sm:mb-20 md:mb-28 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                <button className="flex text-[#FFFFFF] bg-jobsSectionBtnGradient py-3 sm:py-4 px-4 sm:px-6 rounded-[14px] gap-2 items-center w-full sm:w-auto">
                  <span className="text-sm sm:text-base">
                    {t("newLanding.platformFeatures.startTrial")}
                  </span>
                  <ArrowRight className="w-4 h-4" />
                </button>
                <button className="flex text-[#0A0A0A] bg-[#FFFFFF] py-3 sm:py-4 px-4 sm:px-6 rounded-[14px] gap-2 items-center border-2 border-[#0000001A] w-full sm:w-auto">
                  <span className="text-sm sm:text-base">
          ...
          <section className="flex flex-col items-center gap-6 sm:gap-8 md:gap-10 bg-lastSectionGradient py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center w-full max-w-4xl">
              <button className="bg-[#FFFFFF] flex items-center justify-center gap-3 sm:gap-4 py-2.5 sm:py-3 px-4 sm:px-6 text-[#9810FA] rounded-[14px] w-full sm:w-auto">
